              ...
              <?php $itemRemaining=$numberOfItemsStored;
                ...
                if ( ($result->num_rows) > 0) {
                  ...
                  <div class="img-thumbnail" style="background-color:#e6ffff;border:6px solid #454977;border-radius: 32px; margin-right:10supx; margin-left:10px">
                      ...
                      <button type="button" class="btn btn-warning" style="float:left;margin-left:110px">&nbsp&nbspEdit&nbsp&nbsp</button>
                      <!-- &nbsp&nbsp&nbsp&nbsp -->
                      <button type="button" class="btn btn-danger"style="float:right;margin-right:90px">Delete</button>
                     </div>
